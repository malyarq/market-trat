...
1. Скачайте новый `markettrat-extension.zip` из GitHub Releases.
2. Распакуйте его в отдельную временную папку.
3. Найдите старую папку, которую уже выбрали в `chrome://extensions`.
4. Скопируйте новые файлы поверх старых файлов в этой старой папке.
5. Откройте `chrome://extensions`.
6. Нажмите кнопку обновления на карточке `MarketTrat`.
7. Откройте расширение и проверьте, что баннер обновления исчез.
